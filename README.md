...
The composer package is available at Packagist: https://packagist.org/packages/ubtue/vufind-collapse-expand

## Documentation

- [Screenshots and Examples](docs/examples.md)
- [Enabling the module](docs/module_embedding.md)
- [Enabling the VuFindCollapseExpand module along custom code modules](docs/custom_code_dependencies.md)
- [Notes on Solr field types and Indexing](docs/indexing.md)
